 ...
 * Also, how can jUPnP read the "current state" of your service for GENA
 ...
 * will jUPnP obtain the current status? If you'd have used
 * <code>@UpnpStateVariable</code> on your fields, jUPnP would then
 ...
 * class, jUPnP will during binding detect any JavaBean-style getter
 * method that matches the derived property name of the state variable.
 * </p>
 * <p>
 * In other words, jUPnP will discover that your class has a
 ...
 * jUPnP will use this method to read the current state of your
 * service for GENA subscribers and when the state variable is
 * manually queried.
 * </p>
 * <p>
 * If you do not provide a UPnP datatype name in your
 * <code>@UpnpStateVariable</code> annotation, jUPnP will use the type
