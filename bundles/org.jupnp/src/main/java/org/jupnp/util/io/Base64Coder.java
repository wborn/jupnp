...
/* ********  E N C O D I N G   M E T H O D S  ******** */    
    ...
    public static void encode( java.nio.ByteBuffer raw, java.nio.ByteBuffer encoded ){
        ...
        while( raw.hasRemaining() ){
            ...
            raw.get(raw3,0,rem);
            Base64Coder.encode3to4(enc4, raw3, rem, Base64Coder.NO_OPTIONS);
            encoded.put(enc4);
        }   // end input remaining
    }
     ...
     * @see Base64Coder#DO_BREAK_LINES
     * @throws java.io.IOException if there is an error
     * @since 2.0
     */
    ...
    public static byte[] encodeBytesToBytes( byte[] source ) {
        byte[] encoded = null;
        try {
            encoded = encodeBytesToBytes( source, 0, source.length, Base64Coder.NO_OPTIONS );
        } catch( java.io.IOException ex ) {
...
//        }
    ...
    throws java.io.IOException {
        ...
        byte[] decoded = Base64Coder.decodeFromFile(infile);
        java.io.OutputStream out = null;
        try{
            out = new java.io.BufferedOutputStream(
                  new java.io.FileOutputStream( outfile ) );
    ...
    /*
    Compatibility with old seamless.org Base64Coder interface
     */
